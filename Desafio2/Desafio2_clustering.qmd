...
p1 = sns.scatterplot(data = df_cluster,y = 'Prima', x = 'Pmaquina3',
hue = 'HCluster',
ax = ax[0])
p1.set(title = 'CustoProduto por Pmaquina3',ylabel = 'Custo de Matéria Prima',xlabel = 'Preço da Máquina 3')
