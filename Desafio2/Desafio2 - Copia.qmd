...
Inicialmente aplicamos o agrupamento hierárquico usando o método 'ward'.
...
p1 = sns.scatterplot(data = df_cluster,x = 'Prima', y = 'Pmaquina2',
hue = 'HCluster',
ax = ax[0])
...
p1 = sns.scatterplot(data = df_cluster,x = 'Prima', y = 'Pmaquina3',
hue = 'KMeans',
ax = ax[0])
p1.set(title = 'Prima por Pmaquina3',xlabel = 'Custo de Matéria Prima',ylabel = 'Preço da Máquina 3')
