...
Ajustamos o XGBoost sem a variável *Região,* pois o método não permite a adição de variável categóricas
...
names <-  colnames(data_train[, c('Prima', 'CustoProduto', 'Pmaquinabase', 'Regiao') ])
...
svm.tune <- train(x=data_train[, c('Pmaquinabase', 'Prima', 'CustoProduto')],
                  ...
                  method = "dwdRadial",   # Radial kernel
                  tuneLength = 5, 
                  preProcess = c('BoxCox'),
