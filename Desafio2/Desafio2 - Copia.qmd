...
postResample(data_train$Resposta, rf_model$predicted)
...
f <- list(
  Resposta ~ Pmaquinabase,
  Resposta ~ Pmaquinabase,
  Resposta ~Pmaquinabase
)


train_bayes <- scale(data_train[, c('Pmaquinabase', 'Prima')])
train_bayes$Resposta <- data_train$Resposta

## Estimate.
b <- bamlss(f, family = "multinomial", data = train_bayes,reference = "1")
?bamlss
