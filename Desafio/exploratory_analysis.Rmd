...
A escolha do número de clusters foi feita de modo a gerar o maior número de insights acerca de diferentes agrupamentos.
...
arg <- match.call()
ggplot(df, aes(x=eval(arg$var), fill=as.factor(HCluster))) +
...
plot(df_cluster, y, 'Seguro')
plot(df_cluster, MEN, 'Sexo')
plot(df_cluster, PRIVATE, 'Uso do Veículo')
plot(df_cluster, URBAN, 'Região de Condução')
```
