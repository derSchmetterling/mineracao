...
\begin{center}
\vspace*{2cm}
\text{\huge UNIVERSIDADE DE SÃO PAULO}
\end{center}
\vspace*{1.5cm}
\begin{center}
\textbf{{\huge SME 0878 Mineração Estatística de Dados\\}}
\vspace*{2cm}
\textbf{{\huge Desafio 1 - Coverage\\}}
\vspace*{5cm}
\textbf{{\Large Pedro Vinícius Alves Silva - 10727865\\}}
\textbf{{alvespedro769@usp.br\\}}
\end{center}
\setcounter{page}{0}
\newpage
---
